...
SELECT * FROM payment
WHERE cast(payment_date as datetime)
BETWEEN '2005-05-25 00:00:00.000' AND '2005-05-25 23:59:59.000';
...
LIKE ('%behind the scenes%') AND
length < '120' AND rental_duration BETWEEN '5' AND '7'
